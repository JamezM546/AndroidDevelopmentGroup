...
1. **Card Game**
   - **Description:** Interactive Card Game or some sort of Puzzle Game that adapts to your skill. - James

2. **Workout Tracker**
   - **Description:** Workout tracker which lets users log exercises (sets, reps, etc) and view history. - Jhonny


3. **Music Letterboxd**
   - **Description:** Letterboxd but for music/albums, probably without social features. - Jhonny
